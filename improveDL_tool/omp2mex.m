%This is the Matlab interface to the RandomOMP MEX implementation.
%The function is not for independent use, only through Randomp.m.


%OMP2MEX Matlab interface to the RandomOMP MEX implementation.
%  GAMMA = OMP2MEX(D,X,DtX,XtX,G,EPSILON,SPARSE_G,MSGDELTA,MAXATOMS,PROFILE)
%  invokes the RandomOMP MEX function according to the specified parameters. Not
